...
public class PositiveInRange {
    ...
    public int[] solve(int[] A, int[][] B) {
        ...
        for(int i = 1; i < n; i++){
            if(A[i] >= 0){
                prefixCountPosProfit[i] = prefixCountPosProfit[i - 1] + 1;
            }else{
                prefixCountPosProfit[i] = prefixCountPosProfit[i - 1];
            }
        }
        ...
        for(int i = 0; i < q; i++){
            ...
            if(l == 0){
                ...
                answers[i] = prefixCountPosProfit[r] - prefixCountPosProfit[l - 1];
            }
        }
        return answers;
    }
