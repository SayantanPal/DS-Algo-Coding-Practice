...
public class MyCustomHashMap {
    ...
    private MapNode[] hashTable; // array of Map Node object where each obj has a pair (Key, Value)
    ...
    public int get(int key){
       if(this.containsKey(key)){
           return this.hashTable[this.searchIndex(key)].value;
       }
    ...
    public int put(int key, int value){
        ...
        while(isHashCollision(index, key)){
            ...
            index = hashResolutionViaLinearProbing(index);
        }
    ...
    public int searchIndex(int incomingKey){
    ...
    * */
    private int hashResolutionViaLinearProbing(int currHashedIndex){
        int N = hashTable.length;
     ...
     */
    private boolean isHashCollision(int index, int incomingKey){
    ...
    private void reHash(){
        ...
        for(MapNode node: this.hashTable){
            int key = node.key;
            newHashTable[hash(key, newN)] = node;
        }
